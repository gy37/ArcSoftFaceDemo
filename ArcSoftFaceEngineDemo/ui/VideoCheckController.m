...
- (IBAction)changeFront:(UISwitch *)sender {
    [self.cameraController setupCaptureSession:(AVCaptureVideoOrientation)[[UIApplication sharedApplication] statusBarOrientation] isFront:sender.isOn];
    [self.cameraController stopCaptureSession];
    [self.cameraController startCaptureSession];
}
